                                    ...
                                    <div class="pl-5">
                                        <div class="mb-1">
                                            <strong>@Brown Asher</strong><span
                                                ...
                                                form, table</span><strong>Tiny Admin</strong>
                                        </div>
                                    ...
                                    <div class="pl-5">
                                        <div class="mb-3">
                                            <strong>@Kelley Sonya</strong><span
                                                ...
                                                on</span><strong>Advanced table</strong>
                                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-11">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <form class="needs-validation" method="POSt" action="{{ route('user.information.store') }}" >
                                        @csrf
