                    ...
                    <div class="row">
                        ...
                        <div class="col-md-11">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <form class="needs-validation" method="POSt" action="{{ route('user.edu.store') }}">
                                        @csrf
                                        <div class="form-group mb-3">
                                            <label for="address-wpalaceholder">University/School/Institute</label>
                                            <input type="text" name="edu" id="address-wpalaceholder"
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-8 mb-3">
                                                ...
                                                <input type="text" name="start_date" class="form-control drgpicker"
                                                    id="date-input1" value="04/24/2020" aria-describedby="button-addon2">

                                            </div>
                                            <div class="col-md-4 mb-3">
                                                <label for="custom-phone">End Date</label>
                                                <input type="text" name="end_date" class="form-control drgpicker"
                                                    id="date-input2" value="04/24/2024" aria-describedby="button-addon2">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" name="field" id="address-wpalaceholder"
                                                class="form-control" placeholder="Enter ...">
